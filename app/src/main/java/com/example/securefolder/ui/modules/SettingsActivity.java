...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChangePass.setOnClickListener(v -> {
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Changing the password requires re-encrypting all data. This feature is coming in Phase 8.")
        ...
        btnAbout.setOnClickListener(v -> {
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Vault Technology: AES-256 GCM\nHash: PBKDF2\n\nYour data is stored locally. No cloud backup.")
    ...
    private void showWipeDialog() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("This will permanently delete all photos, videos, notes, and passwords inside the vault. This cannot be undone.")
    ...
    private void wipeAllData() {
        ...
        deleteRecursive(photoDir);
        File videoDir = new File(getExternalFilesDir(null), "Vault/Videos");
        deleteRecursive(videoDir);

        // 3. Clear Preferences (Logout)
